...
SOURCES = [
    ...
    # --- خبرگزاری‌های اصلی (نسخه توییتر) ---
    #{"name": "رویترز (Reuters)", "url": "https://nitter.net/Reuters/rss"},
    #{"name": "ایران اینترنشنال", "url": "https://nitter.net/IranIntl/rss"},
    #{"name": "بی بی سی فارسی", "url": "https://nitter.net/bbcpersian/rss"},
    #{"name": "رادیو فردا", "url": "https://nitter.net/RadioFarda_/rss"},
    {"name": "صدای آمریکا (VOA)", "url": "https://nitter.net/VOAIran/rss"},
    #{"name": "تسنیم", "url": "https://nitter.net/Tasnimnews_Fa/rss"},
    ...
    #{"name": "جروزالم پست", "url": "https://nitter.net/Jerusalem_Post/rss"},
